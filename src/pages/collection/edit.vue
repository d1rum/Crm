            ...
            <form @submit.prevent="collectionUpdate" enctype="multipart/form-data">
              ...
              <div class="form-row">
                <div class="custom-file">
                  <label for="customFile">Collection Image</label>
                  <br>
...
export default {
  ...
  created(){
    ...
    axios.get('http://192.168.43.184:8001/api/collection/'+id)
  ...
  methods:{
    ...
    collectionUpdate(){
      let id = this.$route.params.id
      axios.patch('http://192.168.43.184:8001/api/collection/'+id,this.form)
          .then(() => {
