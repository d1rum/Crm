...
<<<<<<< Updated upstream
                      <img :src="'http://192.168.1.233:8001/'+item.collection_image" id="collection_photo">
=======
                      <img :src="'http://192.168.43.131:8001/'+item.collection_image" id="collection_photo">
>>>>>>> Stashed changes
                    </template>
...
>>>>>>> Stashed changes
    ...
    deleteCollection(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
<<<<<<< Updated upstream
          axios.delete('http://192.168.1.233:8001/api/collection/'+id)
=======
          axios.delete('http://192.168.43.131:8001/api/collection/'+id)
>>>>>>> Stashed changes
              .then(() => {
