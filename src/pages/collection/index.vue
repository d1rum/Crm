                ...
                <div class="table-responsive datatable-vue">
                  ...
                  >
                    ...
                    <template v-slot:cell(collectionImage)="{item}">
                      <img :src="'http://192.168.43.184:8001/'+item.collection_image" id="collection_photo">
                    </template>
...
export default {
  ...
  methods:{
    ...
    allCollection(){
      axios.get('http://192.168.43.184:8001/api/collection')
    ...
    deleteCollection(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          axios.delete('http://192.168.43.184:8001/api/collection/'+id)
              .then(() => {
