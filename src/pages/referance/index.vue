                ...
                <div class="table-responsive datatable-vue">
                  ...
                  >
                    ...
                    <template v-slot:cell(referanceImage)="{item}">
                      <img :src="'http://192.168.197.37:8001/'+item.referance_image" id="referance_photo">
                    </template>
...
export default {
  ...
  methods:{
    ...
    allReferance(){
      axios.get('http://192.168.197.37:8001/api/referance')
    ...
    deleteReferance(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          axios.delete('http://192.168.197.37:8001/api/referance/'+id)
              .then(() => {
