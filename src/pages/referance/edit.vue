    ...
    <div>
      ...
      <div class="col-xl-12">
        <div class="card card-statistics">
          <div class="card-body">
            <form @submit.prevent="referanceUpdate" enctype="multipart/form-data">
              <div class="form-row">
...
export default {
  ...
  created(){
    ...
    axios.get('http://192.168.197.37:8001/api/referance/'+id)
  ...
  methods:{
    onFileSelected(event){
      ...
      if(file.size > 20971520) {
        ...
        reader.onload = event => {
          this.form.new_referance_image = event.target.result
    ...
    referanceUpdate(){
      let id = this.$route.params.id
      axios.patch('http://192.168.197.37:8001/api/referance/'+id,this.form)
          .then(() => {
