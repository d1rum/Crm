...
export default {
  ...
  methods:{
    ...
    addDeci(){
      this.$http.post('http://192.168.43.131:8001/api/shipping-company-deci',this.form)
    ...
    getShippingComDeciList(){
        this.$http.get('http://192.168.43.131:8001/api/shipping-company-deci')
          .then((res) => {
            this.items = res.data;
            // eslint-disable-next-line no-console
          })
    ...
    editDeci(id){
      // eslint-disable-next-line no-console
      this.$http.patch('http://192.168.43.131:8001/api/shipping-company-deci/'+id,this.editForm)
          .then((res) => {
            this.items = res.data;
            this.getShippingComDeciList();
            this.displayModal = false;
    ...
    deleteDeci(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          this.$http.delete('http://192.168.43.131:8001/api/shipping-company-deci/'+id)
              .then(() => {
                this.getShippingComDeciList();
