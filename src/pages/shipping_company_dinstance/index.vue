...
export default {
  ...
  methods:{
    ...
    addDistance(){
      this.$http.post('http://172.16.1.66:8001/api/shipping-company-distance',this.form)
    ...
    getDistanceList(){
      this.$http.get('http://172.16.1.66:8001/api/shipping-company-distance')
          .then((res) => {
            this.items = res.data;
            // eslint-disable-next-line no-console
    ...
    editDistance(id){
      // eslint-disable-next-line no-console
      this.$http.patch('http://172.16.1.66:8001/api/shipping-company-distance/'+id,this.editForm)
          .then((res) => {
            this.items = res.data;
            this.getDistanceList();
            this.displayModal = false;
    ...
    deleteDistance(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          this.$http.delete('http://172.16.1.66:8001/api/shipping-company-distance/'+id)
              .then(() => {
                this.getDistanceList();
