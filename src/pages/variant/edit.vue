...
export default {
  ...
  created(){
    ...
    axios.get('http://172.16.2.186:8001/api/variant/'+id)
        .then(({data}) => (this.form = data))
        .catch()
    axios.get('http://172.16.2.186:8001/api/product/')
        .then(({data}) => (this.products = data))
    axios.get('http://172.16.2.186:8001/api/size/')
        .then(({data}) => (this.sizes = data))
    axios.get('http://172.16.2.186:8001/api/color/')
  ...
  methods:{
    ...
    variantUpdate(){
      let id = this.$route.params.id
      axios.patch('http://172.16.2.186:8001/api/variant/'+id,this.form)
          .then(() => {
