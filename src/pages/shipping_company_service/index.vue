...
export default {
  ...
  methods:{
    ...
    addServiceType(){
      this.$http.post('http://172.16.2.186:8001/api/shipping-company-service',this.form)
    ...
    getShipServiceList(){
      this.$http.get('http://172.16.2.186:8001/api/shipping-company-service')
          .then((res) => {
            this.items = res.data;
            // eslint-disable-next-line no-console
    ...
    editService(id){
      // eslint-disable-next-line no-console
      this.$http.patch('http://172.16.2.186:8001/api/shipping-company-service/'+id,this.editForm)
          .then((res) => {
            this.items = res.data;
            this.getShipServiceList();
            this.displayModal = false;
    ...
    deleteService(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          this.$http.delete('http://172.16.2.186:8001/api/shipping-company-service/'+id)
              .then(() => {
                this.getShipServiceList();
