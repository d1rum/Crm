                ...
                <div class="table-responsive datatable-vue">
                  ...
                  >
                    ...
                    <template v-slot:cell(campaignImage)="{item}">
                      <img :src="'http://172.16.2.186:8001/'+item.campaign_image" id="campaign_photo">
                    </template>
...
export default {
  ...
  methods:{
    ...
    allCampaign(){
      axios.get('http://172.16.2.186:8001/api/campaign')
    ...
    deleteCampaign(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          axios.delete('http://172.16.2.186:8001/api/campaign/'+id)
              .then(() => {
