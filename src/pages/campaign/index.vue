                ...
                <div class="table-responsive datatable-vue">
                  ...
                  >
                    ...
                    <template v-slot:cell(campaignImage)="{item}">
                      <img :src="'http://192.168.43.131:8001/'+item.campaign_image" id="campaign_photo">
                    </template>
...
export default {
  ...
  methods:{
    ...
    allCampaign(){
      axios.get('http://192.168.43.131:8001/api/campaign')
    ...
    deleteCampaign(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          axios.delete('http://192.168.43.131:8001/api/campaign/'+id)
              .then(() => {
