                ...
                <div class="table-responsive datatable-vue">
                  ...
                  >
                    ...
                    <template v-slot:cell(blogImage)="{item}">
                      <img :src="'http://192.168.197.37:8001/'+item.blog_image" id="blog_photo">
                    </template>
...
export default {
  ...
  methods:{
    ...
    allBlog(){
      axios.get('http://192.168.197.37:8001/api/blog')
    ...
    deleteBlog(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          axios.delete('http://192.168.197.37:8001/api/blog/'+id)
              .then(() => {
