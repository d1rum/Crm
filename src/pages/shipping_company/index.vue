        ...
        <div class="text-center">
          <b-modal id="edit-modal" v-model="displayModal" title="Edit Shipping Company" hide title-class="font-18">
            ...
            <div class="form-group col-md-2 mt-2" v-if="editForm.shipping_company_image != null">
              <img width="100px" height="100px"  :hidden="hideStatus" :src="'http://172.16.2.186:8001'+'/'+editForm.shipping_company_image" id="shipping_company_image">
            </div>
            <br>
...
export default {
  ...
  methods:{
    ...
    addShipCompany(){
      this.$http.post('http://172.16.2.186:8001/api/shipping-company',this.form)
    ...
    editShipComp(id){
      // eslint-disable-next-line no-console
      this.$http.patch('http://172.16.2.186:8001/api/shipping-company/'+id,this.editForm)
          .then((res) => {
            this.items = res.data;
            this.getShipComList();
            this.displayModal = false;
    ...
    deleteShipCom(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          this.$http.delete('http://172.16.2.186:8001/api/shipping-company/'+id)
              .then(() => {
                this.getShipComList();
