                ...
                <div class="table-responsive datatable-vue">
                  ...
                  >
                    ...
                    <template v-slot:cell(teamImage)="{item}">
                      <img :src="'http://192.168.197.37:8001/'+item.team_image" id="team_photo">
                    </template>
...
export default {
  ...
  methods:{
    ...
    allTeam(){
      axios.get('http://192.168.197.37:8001/api/team')
    ...
    deleteTeam(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          axios.delete('http://192.168.197.37:8001/api/team/'+id)
              .then(() => {
