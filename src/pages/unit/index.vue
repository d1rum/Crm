...
export default {
  ...
  methods:{
    ...
    addUnit(){
      this.$http.post('http://172.16.2.186:8001/api/unit',this.form)
          .then((data) => {
    ...
    getUnitList(){
      this.$http.get('http://172.16.2.186:8001/api/unit')
          .then((res) => {
            this.items = res.data;
            // eslint-disable-next-line no-console
    ...
    editUnit(id){
      // eslint-disable-next-line no-console
      this.$http.patch('http://172.16.2.186:8001/api/unit/'+id,this.editForm)
          .then((res) => {
            this.items = res.data;
            this.getUnitList();
            this.displayModal = false;
    ...
    deleteUnit(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          this.$http.delete('http://172.16.2.186:8001/api/unit/'+id)
              .then(() => {
                this.getUnitList();
