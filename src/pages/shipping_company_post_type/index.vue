...
export default {
  ...
  methods:{
    ...
    addPostType(){
      this.$http.post('http://192.168.1.37:8001/api/shipping-company-post-type',this.form)
    ...
    getPostTypeList(){
      this.$http.get('http://192.168.1.37:8001/api/shipping-company-post-type')
          .then((res) => {
            this.items = res.data;
            // eslint-disable-next-line no-console
    ...
    editPostType(id){
      // eslint-disable-next-line no-console
      this.$http.patch('http://192.168.1.37:8001/api/shipping-company-post-type/'+id,this.editForm)
          .then((res) => {
            this.items = res.data;
            this.getPostTypeList();
            this.displayModal = false;
    ...
    deletePostType(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          this.$http.delete('http://192.168.1.37:8001/api/shipping-company-post-type/'+id)
              .then(() => {
                this.getPostTypeList();
