...
export default {
  ...
  methods:{
    ...
    addColor(){
      this.$http.post('http://192.168.197.37:8001/api/color',this.form)
    ...
    getColorList(){
      this.$http.get('http://192.168.197.37:8001/api/color')
          .then((res) => {
            this.items = res.data;
            // eslint-disable-next-line no-console
            console.log(res);
    ...
    editColor(id){
      // eslint-disable-next-line no-console
      this.$http.patch('http://192.168.197.37:8001/api/color/'+id,this.editForm)
          .then((res) => {
            // eslint-disable-next-line no-console
            console.log(res);
            this.getColorList();
    ...
    deleteColor(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          this.$http.delete('http://192.168.197.37:8001/api/color/'+id)
              .then(() => {
                this.getColorList();
