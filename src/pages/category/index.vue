...
export default {
  ...
  methods:{
    ...
    addCategory(){
      this.$http.post('http://192.168.197.37:8001/api/category',this.form)
          .then((data) => {this.categories = data;
            this.editModalDisplay = false;
            this.getCategoryList();
            this.form.category_name =null;
            this.$toasted.show('hüseyin selamlar :D')
          })
          .catch()
    ...
    editCategory(id){
      ...
      this.$http.patch('http://192.168.197.37:8001/api/category/'+id,this.editForm)
          .then((res) => {
            this.items = res.data;
            this.getCategoryList();
            this.displayModal = false;
    ...
    deleteCategory(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          this.$http.delete('http://192.168.197.37:8001/api/category/'+id)
              .then(() => {
                this.getCategoryList();
