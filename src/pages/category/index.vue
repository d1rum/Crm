...
export default {
  ...
  methods:{
    ...
    addCategory(){
      this.$http.post('http://172.16.2.186:8001/api/category',this.form)
    ...
    editCategory(id){
      ...
      this.$http.patch('http://172.16.2.186:8001/api/category/'+id,this.editForm)
          .then((res) => {
            this.items = res.data;
            this.getCategoryList();
            this.displayModal = false;
    ...
    deleteCategory(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          this.$http.delete('http://172.16.2.186:8001/api/category/'+id)
              .then(() => {
                this.getCategoryList();
