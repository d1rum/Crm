...
=======
      axios.get('http://192.168.43.131:8001/api/customer')
>>>>>>> Stashed changes
    ...
    deleteCustomer(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
<<<<<<< Updated upstream
          axios.delete('http://192.168.1.233:8001/api/customer/'+id)
=======
          axios.delete('http://192.168.43.131:8001/api/customer/'+id)
>>>>>>> Stashed changes
              .then(() => {
