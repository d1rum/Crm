    ...
    <div>
      ...
      <div class="col-xl-12">
        <div class="card card-statistics">
          <div class="card-body">
            <form @submit.prevent="aboutUsInsert" enctype="multipart/form-data">
              <div class="form-row">
...
export default {
  ...
  created(){
    ...
    axios.get('http://192.168.43.131:8001/api/about-us/')
  ...
  methods:{
    ...
    aboutUsInsert(){
      axios.post('http://192.168.43.131:8001/api/about-us',this.form)
          .then(() => {
