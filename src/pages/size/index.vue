...
export default {
  ...
  methods:{
    ...
    addSize(){
      this.$http.post('http://192.168.43.131:8001/api/size',this.form)
          .then((data) => {
    ...
    getSizeList(){
      this.$http.get('http://192.168.43.131:8001/api/size')
          .then((res) => {
            this.items = res.data;
            // eslint-disable-next-line no-console
    ...
    editSize(id){
      // eslint-disable-next-line no-console
      this.$http.patch('http://192.168.43.131:8001/api/size/'+id,this.editForm)
          .then((res) => {
            this.items = res.data;
            this.getSizeList();
            this.displayModal = false;
    ...
    deleteSize(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          this.$http.delete('http://192.168.43.131:8001/api/size/'+id)
              .then(() => {
                this.getSizeList();
