...
export default {
  ...
  methods:{
    completedTask(id){
      this.$http.get('http://192.168.197.37:8001/api/completed-user-task/'+id)
          .then(() => {
            this.getTaskList()
  ...
  console.log(id);
    ...
    getTaskList() {
      ...
      this.$http.get('http://192.168.197.37:8001/api/get-user-task/'+id)
    ...
    addTask(){
      ...
      this.$http.post('http://192.168.197.37:8001/api/task',this.form)
          // eslint-disable-next-line no-console
    ...
    editTask(id){
      ...
      // eslint-disable-next-line no-console
      this.$http.patch('http://192.168.197.37:8001/api/task/'+id,this.editForm)
          .then((res) => {
            this.items = res.data;
            this.getTaskList();
            this.editDisplayModal = false;
    ...
    deleteTask(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          this.$http.delete('http://192.168.197.37:8001/api/task/'+id)
              .then(() => {
                this.getTaskList();
