...
export default {
  ...
  methods:{
    ...
    addRole(){
      this.$http.post('http://192.168.43.131:8001/api/role',this.form)
    ...
    getRoleList(){
      this.$http.get('http://192.168.43.131:8001/api/role')
          .then((res) => {
            this.items = res.data;
    ...
    editRole(id){
      // eslint-disable-next-line no-console
      this.$http.patch('http://192.168.43.131:8001/api/role/'+id,this.editForm)
          .then((res) => {
            this.items = res.data;
            this.getRoleList();
            this.displayModal = false;
    ...
    deleteRole(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          this.$http.delete('http://192.168.43.131:8001/api/role/'+id)
              .then(() => {
                this.getRoleList();
