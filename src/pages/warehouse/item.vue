...
export default {
  ...
  methods:{
    subWarehouses(){
      axios.get('http://192.168.43.131:8001/api/sub-warehouse/list')
    ...
    selectedWarehouseItem(id){
      if (id != "") {
        this.show = true;
        axios.get('http://192.168.43.131:8001/api/select-warehouse-item/'+id)
    ...
    selectedWarehouseItemVariant(id){
      if (id != "") {
        this.show = true;
        axios.get('http://192.168.43.131:8001/api/select-warehouse-item-variant/'+id)
    ...
    deleteWarehouseItem(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          axios.get('http://192.168.43.131:8001/api/warehouse-item/delete/'+id)
              .then(() => {
    ...
    deleteWarehouseItemVariant(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          axios.get('http://192.168.43.131:8001/api/warehouse-item-variant/delete/'+id)
              .then(() => {
