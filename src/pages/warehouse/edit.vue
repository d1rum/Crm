...
export default {
  ...
  created(){
    ...
    axios.get('http://172.16.2.186:8001/api/warehouse/'+id)
        .then(({data}) => (this.form = data))
        .catch()
    axios.get('http://172.16.2.186:8001/api/control-main-warehouse/')
  ...
  methods:{
    warehouseUpdate(){
      let id = this.$route.params.id
      axios.patch('http://172.16.2.186:8001/api/warehouse/'+id,this.form)
          .then(() => {
