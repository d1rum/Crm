...
export default {
  ...
  methods:{
    ...
    addSubCategory(){
      ...
      this.$http.post('http://192.168.1.37:8001/api/subcategory',this.form)
          // eslint-disable-next-line no-console
    ...
    getSubCategoryList(){
      ...
      this.$http.get('http://192.168.1.37:8001/api/subcategory')
          .then((res) => {
            this.items = res.data;
    ...
    editCategory(id){
      // eslint-disable-next-line no-console
      this.$http.patch('http://192.168.1.37:8001/api/subcategory/'+id,this.editForm)
          .then((res) => {
            this.items = res.data;
            this.getSubCategoryList();
            this.editDisplayModal = false;
    ...
    deleteSubCategory(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          this.$http.delete('http://192.168.1.37:8001/api/subcategory/'+id)
              .then(() => {
                this.getSubCategoryList();
