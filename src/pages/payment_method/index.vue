...
export default {
  ...
  methods:{
    ...
    addPaymentMethod(){
      this.$http.post('http://192.168.43.131:8001/api/payment-method',this.form)
    ...
    getPaymentMethodList(){
      this.$http.get('http://192.168.43.131:8001/api/payment-method')
          .then((res) => {
            this.items = res.data;
    ...
    editPaymentMethod(id){
      // eslint-disable-next-line no-console
      this.$http.patch('http://192.168.43.131:8001/api/payment-method/'+id,this.editForm)
          .then((res) => {
            this.items = res.data;
            this.getPaymentMethodList();
            this.displayModal = false;
    ...
    deletePaymentMethod(id){
      ...
      Swal.fire({
        ...
        if (result.value) {
          this.$http.delete('http://192.168.43.131:8001/api/payment-method/'+id)
              .then(() => {
                this.getPaymentMethodList();
